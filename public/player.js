...
const S={ht:[],sr:[],ar:[],sq:'',filter:'all',ct:null,pl:[],pi:-1,ps:'',ip:false,il:false,rm:'off',autoNext:true,yp:null,yr:false,iv:null,pt:0,pd:0,at:'home',ld:{type:'none',lines:[]},cli:-1,lo:false,lyricsLoaded:false,server:'1',lyricsFetching:false};
...
function PK(s,i){
    var l=[];
    if(s==='home0') l=S.ht.slice(0, 6);
    else if(s==='home1') l=S.ht.slice(6, 12);
    else if(s==='home2') l=S.ht.slice(12, 18);
    else if(s==='home3') l=S.ht.slice(18, 24);
    else if(s==='home4') l=S.ht.slice(24, 30);
    else if(s==='home5') l=S.ht.slice(30, 36);
