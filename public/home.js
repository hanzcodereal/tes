const Home = {
    render() {
        ...
        <div class="pt-12 px-4 sticky top-0 z-10 bg-gradient-to-b from-[#1ed760]/20 via-[#1a1a1a] to-[#121212]">
    ...
    async fetch() {
        try {
            ...
            if (allSongs.length > 0) {
                const categories = [
                    { id: 'home-grid', count: 6 },
                    { id: 'home-new', count: 6 },
                    { id: 'home-popular', count: 6 },
                    { id: 'home-tiktok', count: 6 },
                    { id: 'home-galau', count: 6 },
                    { id: 'home-hits', count: 6 }
                ];
                ...
                if (playlistContainer && allSongs.length >= 12) {
